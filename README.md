...
- [Clojure for AI Agent-Assisted Coding](research/clojure-ai-agent-coding.md) — REPL-as-verification advantage, training data deficit, Mycelium/state-machine thesis, ecosystem isolation, "right language for the wrong era" verdict
