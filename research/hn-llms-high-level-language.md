...
**Insight cross-references:** Confirms [Broken Abstraction Contract](../insights.md#broken-abstraction-contract), [Democratization-Failure Tradeoff](../insights.md#democratization-failure-tradeoff), [Theory Formation Threshold](../insights.md#theory-formation-threshold). Source for [Prompt Expansion](../insights.md#prompt-expansion) (compilation constrains, generation expands — opposite operations; 11 output factors, 5 non-locality sources, review burden, compiler-framing harm).
