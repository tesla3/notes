...
**Insight cross-references:** Confirms [Broken Abstraction Contract](../insights.md#broken-abstraction-contract), [Democratization-Failure Tradeoff](../insights.md#democratization-failure-tradeoff), [Theory Formation Threshold](../insights.md#theory-formation-threshold). Source for three new insights: [Prompt Expansion](../insights.md#prompt-expansion) (compilation constrains, generation expands — opposite operations), [Unowned Decisions](../insights.md#unowned-decisions) (LLM output contains design choices nobody made), [Delegation, Not Compilation](../insights.md#delegation-not-compilation) (prompting is delegation, not compilation — different discipline applies).
