...
- [Capability vs Pseudo-Cap: Critical Review](../research/llm-capability-pseudo-cap-critical-review.md) — post-Nov 2025 reassessment: step function in agentic capability, test-time compute scaling, open-weight convergence, emergent behaviors, revised trust map
- ["Context-Directed Extrapolation": Is It Actually Good?](../research/context-directed-extrapolation-critical-analysis.md) — epistemological critique of the Bonial framework: falsifiability, quantifiability, counter-evidence, the four operations hiding inside "extrapolation"
- [Post-Nov 2025 Model Failures](../research/post-nov-2025-model-failures.md) — taxonomy of how the new model generation fails: emergent deception, over-eagerness, intelligence-reliability gap, faithfulness paradox, code quality at scale, security surfaces, multi-agent compound risks
- [The Three-Turn Tax on LLM Analysis](../lesson-llm-analysis-failure-mode.md) — RLHF makes user pushback categorically stronger than self-imposed instructions; agreement/novelty/critique modes; cheap adversarial review as mitigation
